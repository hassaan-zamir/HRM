...
@section('content')
@include('department.partials.header', ['title' => __('Edit Department')])
          ...
          <form method="post" action="{{ route('department.update', $department) }}" autocomplete="off">
            ...
            <div class="pl-lg-4">
              ...
              <div class="form-group{{ $errors->has('details') ? ' has-danger' : '' }}">
                ...
                <textarea name="details" id="input-details" class="form-control form-control-alternative{{ $errors->has('details') ? ' is-invalid' : '' }}" required="required">{{ old('details',$department->details) }}</textarea>
