@extends('layouts.app', ['title' => __('Multiple In/Out Report')])
      ...
      <div class="card bg-secondary shadow">
        <div class="card-header bg-white border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">{{ __('Employees Multiple In/Out Report') }}</h3>
            </div>
        ...
        <div class="card-body">
          <form method="post" action="{{ route('reports.multiple_in_out') }}" autocomplete="off">
            @csrf
            ...
            <h6 class="heading-small text-muted mb-4">{{ __('Muliple In/Out Report') }}</h6>
            <div class="pl-lg-4">
