          ...
          <form method="post" action="{{ route('shift.store') }}" autocomplete="off">
            ...
            <div class="pl-lg-4">
              ...
              <div class="form-group{{ $errors->has('duration_hour','duration_mins') ? ' has-danger' : '' }}">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <input type="number" name="duration_hour" id="input-duration_hour" class="form-control  form-control-alternative{{ $errors->has('duration_hour') ? ' is-invalid' : '' }}" placeholder="{{ __('Hrs') }}" value="{{ old('duration_hour') }}" required>
                  </div>
                  <div class="col-md-6">
                    <input type="number" name="duration_mins" id="input-duration_mins" class="form-control form-control-alternative{{ $errors->has('duration_mins') ? ' is-invalid' : '' }}" placeholder="{{ __('Mins') }}" value="{{ old('duration_mins') }}" required>
                  </div>
              ...
              <div class="form-group{{ $errors->has('late_duration_hour','late_duration_mins') ? ' has-danger' : '' }}">
                ...
                <br>
                <input type="number" name="late_duration_hour" id="input-late_duration_hour" class="col-md-3  form-control-alternative{{ $errors->has('late_duration_hour') ? ' is-invalid' : '' }}" placeholder="{{ __('Hrs') }}" value="{{ old('late_duration_hour') }}" required> Hrs
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="number" name="late_duration_mins" id="input-late_duration_mins" class="col-md-3 form-control-alternative{{ $errors->has('late_duration_mins') ? ' is-invalid' : '' }}" placeholder="{{ __('Mins') }}" value="{{ old('late_duration_mins') }}" required> Mins
              ...
              <div class="form-group{{ $errors->has('early_duration_hour','early_duration_mins') ? ' has-danger' : '' }}">
                ...
                <br>
                <input type="number" name="early_duration_hour" id="input-early_duration_hour" class="col-md-3  form-control-alternative{{ $errors->has('early_duration_hour') ? ' is-invalid' : '' }}" placeholder="{{ __('Hrs') }}" value="{{ old('early_duration_hour') }}" required> Hrs
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="number" name="early_duration_mins" id="input-early_duration_mins" class="col-md-3 form-control-alternative{{ $errors->has('early_duration_mins') ? ' is-invalid' : '' }}" placeholder="{{ __('Mins') }}" value="{{ old('early_duration_mins') }}" required> Mins
              ...
              <div class="form-group{{ $errors->has('overtime_duration_hour','overtime_duration_mins') ? ' has-danger' : '' }}">
                ...
                <br>
                <input type="number" name="overtime_duration_hour" id="input-overtime_duration_hour" class="col-md-3  form-control-alternative{{ $errors->has('overtime_duration_hour') ? ' is-invalid' : '' }}" placeholder="{{ __('Hrs') }}" value="{{ old('overtime_duration_hour') }}" required> Hrs
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="number" name="overtime_duration_mins" id="input-overtime_duration_mins" class="col-md-3 form-control-alternative{{ $errors->has('overtime_duration_mins') ? ' is-invalid' : '' }}" placeholder="{{ __('Mins') }}" value="{{ old('overtime_duration_mins') }}" required> Mins
