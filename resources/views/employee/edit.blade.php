...
@section('content')
    @include('employee.partials.header', ['title' => __('Edit Employee')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Employee Edit') }}</h3>
                            </div>
                    ...
                    <form method="post" action="{{ route('employees.updating') }}" autocomplete="off" style="margin-top:20px;">
